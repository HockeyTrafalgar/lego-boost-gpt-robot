...
const waitForValueToSet = function (valueName, compareFunc = valueNameToCompare => this[valueNameToCompare], timeoutMs = 0) {
    if (compareFunc.bind(this)(valueName))
        return Promise.resolve(this[valueName]);
    return new Promise((resolve, reject) => {
        setTimeout(() => __awaiter(this, void 0, void 0, function* () { return resolve(yield waitForValueToSet.bind(this)(valueName, compareFunc, timeoutMs)); }), timeoutMs + 100);
    });
};
export class HubAsync extends Hub {
    constructor(bluetooth, configuration) {
        super(bluetooth);
    ...
    motorAngleAsync(port, angle, dutyCycle = 100, wait = false) {
        return new Promise((resolve, _) => {
            this.motorAngle(port, angle, dutyCycle, () => __awaiter(this, void 0, void 0, function* () {
                if (wait) {
                    let beforeTurn;
                    do {
                        beforeTurn = this.portData[port].angle;
                        yield new Promise(res => setTimeout(res, CALLBACK_TIMEOUT_MS));
    ...
    motorAngleMultiAsync(angle, dutyCycleA = 100, dutyCycleB = 100, wait = false) {
        return new Promise((resolve, _) => {
            this.motorAngleMulti(angle, dutyCycleA, dutyCycleB, () => __awaiter(this, void 0, void 0, function* () {
                if (wait) {
                    let beforeTurn;
                    do {
    ...
    driveUntil(distance = 0, wait = true) {
        return __awaiter(this, void 0, void 0, function* () {
            const distanceCheck = distance !== 0 ? (this.useMetric ? distance : distance * 2.54) : this.configuration.defaultStopDistance;
            ...
            if (wait) {
                yield waitForValueToSet.bind(this)('distance', compareFunc);
                yield this.motorAngleMultiAsync(0);
            }
            else {
    ...
    turnUntil(direction = 1, wait = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (wait) {
                yield waitForValueToSet.bind(this)('distance', () => this.distance >= this.configuration.defaultClearDistance);
                yield this.turn(0, false);
            }
            else {
                return waitForValueToSet
