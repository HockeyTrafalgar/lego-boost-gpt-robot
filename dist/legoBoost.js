...
export default class LegoBoost {
    ...
    connect(configuration = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const bluetooth = yield BoostConnector.connect(this.handleGattDisconnect.bind(this));
    ...
    changeLed() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.hub.ledAsync(this.color);
        });
    }
    /**
     * Drive forward until wall is reaced or drive backwards 100meters
     ...
     * @returns {Promise}
     */
    driveToDirection(direction = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.preCheck())
                return;
            if (direction > 0)
                return yield this.hub.driveUntil();
            else
                return yield this.hub.drive(-10000);
        });
    }
    /**
    ...
    stop() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.hub.motorTimeMultiAsync(1, 0, 0);
        });
    }
    /**
    ...
    ledAsync(color) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.preCheck())
                return;
            return yield this.hub.ledAsync(color);
        });
    }
    /**
     ...
     * @returns {Promise}
     */
    motorTimeAsync(port, seconds, dutyCycle = 100, wait = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.preCheck())
                return;
            yield this.hub.motorTimeAsync(port, seconds, dutyCycle, wait);
        });
    }
    /**
     ...
     * @returns {Promise}
     */
    motorTimeMultiAsync(seconds, dutyCycleA = 100, dutyCycleB = 100, wait = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.preCheck())
                return;
            yield this.hub.motorTimeMultiAsync(seconds, dutyCycleA, dutyCycleB, wait);
        });
    }
    /**
     ...
     * @returns {Promise}
     */
    motorAngleAsync(port, angle, dutyCycle = 100, wait = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.preCheck())
                return;
            yield this.hub.motorAngleAsync(port, angle, dutyCycle, wait);
        });
    }
    /**
     ...
     * @returns {Promise}
     */
    motorAngleMultiAsync(angle, dutyCycleA = 100, dutyCycleB = 100, wait = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.preCheck())
                return;
            yield this.hub.motorAngleMultiAsync(angle, dutyCycleA, dutyCycleB, wait);
        });
    }
    /**
    ...
    drive(distance, wait = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.preCheck())
                return;
            return yield this.hub.drive(distance, wait);
        });
    }
    /**
    ...
    turn(degrees, wait = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.preCheck())
                return;
            return yield this.hub.turn(degrees, wait);
        });
    }
    /**
     ...
     * @returns {Promise}
     */
    driveUntil(distance = 0, wait = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.preCheck())
                return;
            return yield this.hub.driveUntil(distance, wait);
        });
    }
    /**
     ...
     * @returns {Promise}
     */
    turnUntil(direction = 1, wait = true) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.preCheck())
                return;
            return yield this.hub.turnUntil(direction, wait);
        });
    }
    /**
     * Send raw data
